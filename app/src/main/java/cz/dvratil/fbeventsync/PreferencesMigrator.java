...
public class PreferencesMigrator {
    ...
    private static void updateToVersion1(SharedPreferences prefs, SharedPreferences.Editor editor, Context context) {
        int wrongColor = 3889560;
        int correctColor = context.getResources().getColor(R.color.colorFBBlue);

        List<Integer> keys = Arrays.asList(R.string.pref_calendar_attending_color,
